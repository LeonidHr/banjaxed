(() => {
    ...
    (() => {
        ...
        function showPopup(form, isSucsess, response = "") {
            setTimeout((() => {
                if (flsModules.popup) {
                    const popup = form.dataset.popupMessage, popupTitle = document.querySelector("[popap-title]"), popupImg = document.querySelector("[popap-img]");
                    if (isSucsess) {
                        popupTitle.innerHTML = "Successfully sent";
                        popupImg.setAttribute("src", "img/partner/modal-sucsess.png");
                    } else {
                        popupTitle.innerHTML = `Error ${response.status}. Form not sent`;
                        popupImg.setAttribute("src", "img/partner/modal-error.png");
                    }
        ...
        function initSliders() {
            if (document.querySelector(".slider-reviews__slider")) new core(".slider-reviews__slider", {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            function wrappingLettersInSpans() {
                const word = document.querySelector("[data-word]"), wordArr = word.innerHTML.split("");
                word.innerHTML = "";
            ...
            function animLetters() {
                const word = document.querySelector("[data-word]"), letters = word.querySelectorAll("span");
                if (countAnim < letters.length) try {
            ...
            function getLineHeight() {
                const items = document.querySelectorAll(".item-why"), lines = document.querySelectorAll(".item-why__line-main");
                items.forEach(((item, i) => {
                    const currHeight = item.getBoundingClientRect().height / 2 - 45;
                    let nextHeight = 0;
                    if (item.nextElementSibling) nextHeight = item.getBoundingClientRect().height / 2;
            ...
            function addTriangleToSelect(e) {
                ...
                currSelect.forEach((select => {
                    ...
                    if (select.closest(".form__column_phone")) try {
            ...
            function changePhone(inputClass, value) {
                ...
                if ("ukr" === value) input.setAttribute("placeholder", "(+380) 000000000");
                if ("usa" === value) input.setAttribute("placeholder", "(+1) 000000000");
                if ("gb" === value) input.setAttribute("placeholder", "(+44) 000000000");
            }
            setTimeout((() => {
                if (flsModules.popup) flsModules.popup.open("#popup");
            }), 4e3);
        }));
        window["FLS"] = true;
        isWebp();
